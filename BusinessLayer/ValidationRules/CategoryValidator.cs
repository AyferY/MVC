...
{
    public class CategoryValidator:AbstractValidator<Category>  //Üzerinde çalışacağın sınıfı buraya key olarak vermelisin.
                                                                 //Biz burada Category üzerinde çalışıyoruz.
    {
